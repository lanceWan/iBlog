...
<section class="breadcrumbs-v1">
    <div class="container">
        <h2 class="breadcrumbs-v1-title">Tag:{{$tag->name}}</h2>
            ...
            <div class="blog-grid-box-shadow">
                ...
                <div class="blog-grid-supplemental">
                    <span class="blog-grid-supplemental-title">
                        <a class="blog-grid-supplemental-category" href="{{url('cate/'.$v->category_id)}}"><i class="fa fa-leaf"></i> {{FrontRepository::getArticleCategory($v->category_id)}}</a>
